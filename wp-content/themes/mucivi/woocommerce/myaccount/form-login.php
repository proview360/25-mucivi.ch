        ...
        <div class="u-column1 col-1">
            ...
            <form class="woocommerce-form woocommerce-form-login login" method="post">
                ...
                <p class="form-row">
                    ...
                    <div class="d-flex gap-1 align-items-center custom-login-form">
                        <button type="submit"
                        ...
                        <div class="form-check" id="remember-me">
                            ...
                            <label class="form-check-label gn-t woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme" for="rememberme">
