...
<div class="container">
    <h1 class="page-title text-center cart-empty-title"><?php echo __( 'Your shopping cart is currently empty.', 'mucivi' ); ?></h1>
	<p class="return-to-shop text-center gn-return-to-shop">
