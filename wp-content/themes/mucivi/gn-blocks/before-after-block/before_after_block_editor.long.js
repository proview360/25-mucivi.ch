(function(blocks, element, data, editor, components, blockEditor) {
    ...
    //register block
    blocks.registerBlockType('gn/before-after-block', {
        ...
        edit: function(props) {
            ...
            if (!props.attributes.image_before) {
                image_not_present_1 = "gn-image-not-present";
            }

            var image_not_present_2 = "";
            if (!props.attributes.image_after) {
            ...
            function update_image_before(newContent) {
                props.setAttributes({image_before: newContent})
            }

            function remove_image_before() {
                props.setAttributes({image_before: null})
            }

            function update_image_after(newContent) {
                props.setAttributes({image_after: newContent})
            }

            function remove_image_after() {
                props.setAttributes({image_after: null})
            }
            ...
            return (
                el(Fragment, null,
                    ...
                    el("div", {
                        ...
                        el("h3", null, "Before / After block"),

                        el("dl", null,

                            el("div", {},
                                el("dt", {class: "ele-1"}, "Image before"),
                                el("dd", {class: "ele-1"},
                                    el(MediaUpload, {
                                        onSelect: update_image_before,
                                        accept: "image/*",
                                        allowedTypes: 'image',
                                    ...
                                    el("button",
                                        {
                                            ...
                                            onClick: remove_image_before
                                        },
                                        "Remove Image"),
                                    el("div", null,
                                        props.attributes.image_before && el("img", {
                                            src: props.attributes.image_before["url"]
                                        })
                                    )
                                )
                            ),
                            ...
                            el("div", {},
                                el("dt", {class: "ele-1"}, "Image After"),
                                el("dd", {class: "ele-1"},
                                    el(MediaUpload, {
                                        onSelect: update_image_after,
                                        accept: "image/*",
                                        allowedTypes: 'image',
                                        render: function render(_ref) {
                                            var open = _ref.open;
                                    ...
                                    el("button",
                                        {
                                            ...
                                            onClick: remove_image_after
                                        },
                                        "Remove Image"),
                                    el("div", null,
                                        props.attributes.image_after && el("img", {
                                            src: props.attributes.image_after["url"]
                                        })
                                    )
                                )
                            ),
